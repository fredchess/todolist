    ...
    <div class="container">
        ...
        <div class="btn-group" role="group" style="margin-bottom: 10px">
            ...
            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                <a class="dropdown-item" href="{{ route('list.show.completed', $list->id) }}">Completed</a>
                <a class="dropdown-item" href="{{ route('list.show.nocompleted', $list->id) }}">No Completed</a>
                <a class="dropdown-item" href="{{ route('list.show.running', $list->id) }}">Running</a>
            </div>
        </div>
        <table class="table">
